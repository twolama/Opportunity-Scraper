...
def run_daily_tasks():
    print("[Run] Running scheduled job...")
...
def start_scheduler():
    ...
    schedule.every().day.at("06:33").do(run_daily_tasks)  # 09:09 PM Ethiopia
    schedule.every().day.at("09:37").do(run_daily_tasks)  # 09:09 PM Ethiopia
